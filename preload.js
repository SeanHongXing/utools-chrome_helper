...
let tabListCache = []
const PinyinMatch = require('./pinyin/src/index')
    ...
    'incognito_mode': {
        ...
        args: {
            enter: (action) => {
                ...
                cp.execFile(chromePath, ['--incognito', url], () => {
                    window.utools.outPlugin()
                })
            }
        }
    ...
    'chrome_bookmarks': {
        ...
        args: {
            ...
            search: (action, searchWord, callbackSetList) => {
                ...
                return callbackSetList(bookmarksDataCache.filter(x => x.lowTitle.includes(searchWord) || x.lowUrl.includes(searchWord) || PinyinMatch.match(x.lowTitle, searchWord) !== false))
            },
