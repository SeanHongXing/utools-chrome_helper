!function (n, e) {
    "object" == typeof exports && "object" == typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define([], e) : "object" == typeof exports ? exports.PinyinMatch = e() : n.PinyinMatch = e()
    ...
    return function (n) {
        ...
        function i(a) {
            ...
            var u = e[a] = {i: a, l: !1, exports: {}};
            return n[a].call(u.exports, u, u.exports, i), u.l = !0, u.exports
        }

        return i.m = n, i.c = e, i.d = function (n, e, a) {
            i.o(n, e) || Object.defineProperty(n, e, {enumerable: !0, get: a})
        }, i.r = function (n) {
            ...
            if (i.r(a), Object.defineProperty(a, "default", {
                enumerable: !0,
                value: n
            }), 2 & e && "string" != typeof n) for (var u in n) i.d(a, u, function (e) {
                return n[e]
            }.bind(null, u));
            return a
        }, i.n = function (n) {
        ...
        e.pinyin_dict_notone = a, e.allPinyin = u
    }, function (n, e, i) {
        "use strict";
        var a = i(0).pinyin_dict_notone, u = i(0).allPinyin, o = function () {
            var n = {};
            for (var e in a) for (var i = a[e], u = 0, o = i.length; u < o; u++) n[i[u]] ? n[i[u]] = n[i[u]] + " " + e : n[i[u]] = e;
            return n
        }(), t = {};

        function r(n) {
            for (var e = [], i = (n.length, []), a = 0; a <= n.length; a++) i.push(!0);
            return function n(e, i, a, o, t) {
                if (e === i.length) return void o.push(a.join(" "));
                for (var r = function (r) {
                    var g = i.substring(e, r + 1), h = !1;
                    if (u.some((function (n) {
                        return 0 === n.indexOf(g)
                    })) && !i[r + 1] && t[r + 1]) {
                        if (1 === g.length) a.push(g); else {
                            var f = [];
                        ...
                        h = !0
                    } else -1 !== u.indexOf(g) && t[r + 1] && (a.push(g), h = !0);
                    if (h) {
                        var c = o.length;
                        n(r + 1, i, a, o, t), o.length === c && (t[r + 1] = !1), a.pop()
                    }
                }, g = e; g < i.length; g++) r(g)
            }(0, n, [], e, i), e
        }
        ...
        function g(n) {
            ...
            return r(n).forEach((function (n) {
                ...
                i[a].indexOf(",") ? i[a].split(",").forEach((function (n) {
                    i.splice(a, 1, n), e.push(JSON.parse(JSON.stringify(i)))
                })) : e.push(i)
            })), 0 !== e.length && e[0].length === n.length || e.push(n.split("")), t = function (n, e, i) {
        ...
        function h(n, e, i, a) {
            ...
            return u.forEach((function (n) {
                n.length > 0 && a && u.push(n.charAt(0))
            })), i ? u.some((function (n) {
        ...
        function f(n, e, i) {
            for (var a = 0; a < n.length; a++) for (var u = 0; u < e.length; u++) {
                var o = e[u], t = o.length, r = t === i.length, g = !0, f = 0, c = 0, l = 0;
                if (t <= n.length) {
                    for (; f < o.length; f++) if (0 === f && " " === n[a + f + c]) c += 1, f -= 1; else if (" " === n[a + f + l]) l += 1, f -= 1; else if (!h(n[a + f + l], o[f], !n[a + f + 1] || !o[f + 1], r)) {
                        g = !1;
                        break
                    }
                    if (g) return [a + c, l + a + f - 1]
                }
            }
            return !1
        }
        ...
        var c = {
            match: function (n, e) {
                n = n.toLowerCase(), e = e.replace(/\s+/g, "").toLowerCase();
                var i = n.indexOf(e);
                if (-1 !== i) return [i, i + e.length - 1];
                var a = f(n.split(""), [e.split("")], e);
